...
from vision_system.StewartPlatform import StewartPlatform
import cv2
from pupil_apriltags import Detector


"""
ros-specific changes to be aware of:
Modified import statements in lines 6 and 7
Camera/video initialization method starting at line 191
cv2.waitkey(1) added in line 224 - video would not render without this line
"""
...
class Camera:
    ...
    def __init__(self, id, cameraParams, cameraDist, cam_R, cam_t):
        ...
        # # Camera Capture Methods: Only uncomment the lines associated with the specific method
